...
import com.xavier.common.util.StringUtils;
...
public class FastDFSClient {
	...
	public static final Map<String, String> EXT_MAPS = new HashMap<>();/* ContentType */
	private static final String FILENAME = "filename";/* 文件名称 */
	private int maxFileSize = 100 * 1000 * 1000;/* 文件最大的大小 */
	...
	public String upload(String base64, String filename, Map<String, String> descriptions) throws FastDFSException, IOException {
		...
		return upload(new ByteArrayInputStream(Base64.decode(base64)), filename, descriptions);
	}
	...
	public String upload(InputStream is, String filename, Map<String, String> descriptions) throws FastDFSException {
		...
		if (descriptions != null && descriptions.size() > 0) {
			descriptions.forEach(
					(key, value) -> nvpsList.add(new NameValuePair(key, value))
			);
		}
		if (nvpsList.size() > 0) {
	...
	/**
	 * <p>获取FastDFS文件的名称，如：M00/00/00/wKgzgFnkTPyAIAUGAAEoRmXZPp876.jpeg</p>
	 *
	...
	/**
	 * <p>Set max file size, default 100M</p>
	 *
